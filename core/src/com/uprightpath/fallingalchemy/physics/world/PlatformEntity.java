...
public class PlatformEntity extends RailEntity {
    ...
    public Vector2 getPosition(AgentEntity agentEntity) {
        if (agentEntity.getRail() == null && !this.collides
                && (Intersector.pointLineSide(start, end, agentEntity.leftBoundingSidePrevious) < 0 || Intersector.pointLineSide(start, end, agentEntity.rightBoundingSidePrevious) < 0)) {
            return null;
        }
