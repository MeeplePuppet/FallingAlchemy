package com.uprightpath.fallingalchemy.builders;
...
import com.uprightpath.fallingalchemy.physics.*;
import com.uprightpath.fallingalchemy.agentintelligence.agents.StupidSlime;
import com.uprightpath.fallingalchemy.physics.AgentEntity;
import com.uprightpath.fallingalchemy.physics.CollisionEntity;
import com.uprightpath.fallingalchemy.physics.EdgePlatformEntity;
...
public class WorldBuilder {
    ...
    public void buildSurface(String name, PhysicsWorld physicsWorld, Vector3[] surfaceVectors, boolean isCollides) {
        buildSurface(name, physicsWorld, surfaceVectors, isCollides, .2f);
    }
    ...
    public void buildUnevenSurface(String name, PhysicsWorld physicsWorld, Vector3[] surfaceVectors, boolean isCollides) {
        buildUnevenSurface(name, physicsWorld, surfaceVectors, isCollides, .2f);
    }
    ...
    public void buildPlatform(String name, PhysicsWorld physicsWorld, Vector3[] surfaceVectors) {
        buildPlatform(name, physicsWorld, surfaceVectors, .2f);
    }
    ...
    public void buildStupidSlime(String name, PhysicsWorld physicsWorld, Vector2 position) {
        ...
        agentEntity.setAgentStats(stats);
